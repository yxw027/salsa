...
struct MocapFunctor
{
  ...
  MocapFunctor(const double &dt_m, const xform::Xformd &x_u2m, const Vector7d& _xm,
               const Vector6d& _xmdot, const Matrix6d& _Xi,
               int idx, int node, int kf);
